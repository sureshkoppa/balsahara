        ...
        /*the folowing function is called when view Medical General register form is submitted*/
           ...
           //alert('hi'+$("#gender").val);
                   ...
                   *************REG EX*************************/
                                ...
                                //alert('hi');
                                $dialog.html("Please choose the date when you want to schedule the exam.");
                                ...
                                return false;
                                            ...
                                            //alert('hi');
                                            $dialog.html("Please maximum marks for the exam.");
                                            $dialog.parent().addClass( "ui-state-error" );
                                            $dialog.dialog('open');
                                            return false;
                                            }
                                                    ...
                                                    $dialog.html("Please enter digits only as maximum marks.");
                                                    $dialog.parent().addClass( "ui-state-error" );
                                                    $dialog.dialog('open');
                                                    return false;
