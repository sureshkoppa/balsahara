        ...
        /*the folowing function is called when view Medical General register form is submitted*/
           ...
           //alert('hi'+$("#gender").val);
                  ...
                  //var arr = new Array();
                   ...
                   //arr= $("#promotedIds").val();
                   //alert($("#promotedIds:checked").val());
                   
                   if ($("#promotedIds:checked").val()== undefined) {
                                //alert('hi');
                                $dialog.html("Please tick the check boxes on the first column to promote seleceted students.");
                                ...
                                //alert('hi');
                                $dialog.html("Please Choose the class or course for transfering the children.");
                                $dialog.parent().addClass( "ui-state-error" );
                                $dialog.dialog('open');
                                return false;
                                }
