...
function isEmpty(i){
    ...
    function findPath(i){
    var I=document.getElementsByTagName('html')[0].innerHTML,l=new RegExp('<scr'+'ipt[^>]+?src\\s*=\\s*["\']?([^>]+?/|)('+i+')([^"\'\\s]*)[^>]*>(.|[\r\n])*?</scr'+'ipt>','i'),o=I.match(l);
    if(o){
        if(!o[1])o[1]="";
    ...
    var I=document.getElementsByTagName('html')[0].innerHTML,l=new RegExp('<scr'+'ipt[^>]+?src\\s*=\\s*["\']?(?:[^>]+?/|)'+i+'([^#"\']*).+?</scr'+'ipt>','i'),o=I.match(l);
...
function parseQuery(i){
    ...
    for(var I=0,l=i.length,o={},O,Q;I<l;I++){
        ...
        if(Q)if('array'==typeof(Q))o[O[0]][o[O[0]].length]=O[1];else o[O[0]]=[o[O[0]],O[1]];else o[O[0]]=O[1]
            }
            return o
    }
    ...
    for(var o=0,O=arguments.length;o<O;o++){
        ...
        for(var Q in l){
            ...
            if(null==I){
                ...
                if(isArray(i[Q]))i[Q]=i[Q].concat(I).unique();else i[Q]=I.slice(0);
            }else if(isScalar(I)||isFunction(I)){
                i[Q]=I
                }else{
                if(i.hasOwnProperty(Q))i[Q]=mergeObject(i[Q],I);else i[Q]=cloneObject(I);
            }
        }
        }
        return i
...
function loadStyleSheet(i){
    if(!hasStyleSheet(i)){
        var I=document.getElementsByTagName('head')[0],l=document.createElement('link');
        l.rel='stylesheet';
        l.type='text/css';
        l.href=i;
        I.appendChild(l);
...
if(isUndefined(Array.prototype.map)){
    ...
    Array.prototype.flatten=function(i,I){
        ...
        if(isArray(i)){
            ...
            for(var o=0,O=i.length;o<O;o++)l[i[o]]=true
                }
                var Q=[];
...
if(isUndefined(Array.prototype.filter)){
    ...
    Array.prototype.binSearch=function(i,I){
        var l=0,o=this.length,O=Math.max(o-1,0),Q=Math.ceil(o/2),_=0;
        if(null!=I)while((!this[Q]||i!=this[Q][I])&&o>=l){
            if(this[Q]&&i>this[Q][I])l=Q+1;else o=Q-1;
            Q=Math.max(0,Math.ceil((o+l)/2))
            }else while(i!=this[Q]&&o>=l){
            if(i>this[Q])l=Q+1;else o=Q-1;
            Q=Math.max(0,Math.ceil((o+l)/2));
        }
        return Q
        }
...
if(isUndefined(Array.range)){
    Array.range=function(i,I,l){
        ...
        if(!isNumber(l))l=1;
        if(!isNumber(I))I=0;
        var o=[],O=Math.min(I,i),Q=Math.max(I,i),_=Math.abs(l),c=-1;
        do{
            c++;
            o[c]=O;
            O+=_
...
DOM.getParent=function(i,I,l){
    ...
    else if(i.nodeType==1&&((!isUndefined(l)&&i[I]==l)||('string'==typeof I&&DOM.hasTagName(i,I))||i==I))return i;else return arguments.callee(i.parentNode,I,l);
};

DOM.getOffset=function(i){
    var I=true,l=i,o=0,O=0,Q=0,_=0,c=null,C=null;
...
DOM.getClientWidth=function(i){
    var I=this.getWindow(i),l=I.document,o=0;
...
DOM.getBodyScrollTop=function(i){
    var I=this.getWindow(i),l=I.document;
...
DOM.color2rgb=function(i){
    ...
    if(/^([a-z]+)($|\s[a-z]+)/i.test(i)){
        ...
        if(I=i.match(/^#([\da-f]{6})$/i)){
            return I=parseInt(I[1],16),[(I&0xff0000)>>16,(I&0xff00)>>8,(I&0xff)]
            }else if(I=i.match(/^#([\da-f]{3})$/i)){
            return I=parseInt(I[1],16),[((I&0xf00)>>8)*0x11,((I&0xf0)>>4)*0x11,(I&0xf)*0x11]
...
DOM.StyleSheet=(function(){
    var _=function(i,c){
        ...
        var e=function(o){
            var O=0;
//            if(i&&o){
//                var Q=c.document.getElementsByTagName("link"),V=new RegExp(i+"$","i");
...
var v=function(){
    var o=[];
    if(i){
        var O=c.document.getElementsByTagName('head')[0],Q=new RegExp('<link[^>]+?href\\s*=\\s*["\']?(([^>]+?/|)'+i+'[^"\'\\s]*)[^>]*>','ig'),V=Q.exec(O.innerHTML);
        while(V&&V[1]){
            o.push(V[1]);
...
C.add=function(){
    if(!C.exists()){
        var O=c.document.getElementsByTagName('head')[0],Q=c.document.createElement('link');
        Q.rel='stylesheet';
        Q.type='text/css';
        Q.href=i;
        O.appendChild(Q);
...
var EM=new function(){
    ...
    var x=function(i){
        Z(i);
        var l=null,O=null,Q=i.target,c=true,X=true;
        if(!i.currentTarget||!(l=i.currentTarget[V.UEID])||!(O=e[l].handler[i.type]))return;
        for(var s=0,S=O.length;s<S;s++)X=X&&!(false===O[s].call(i.currentTarget,i));
        return X
        };
...
(function(){
    var O=EM.registerEvent(window,'domload'),Q=false,_=function(){
...
String.prototype.sprintf=function(){
    var l=isArray(arguments[0])?arguments[0]:arguments,o=0,O=this.replace(/%%/g,"\0\0"),Q= /%((?:\d+\$)?)((?:[-0+# ])?)((?:\d+|\*(?:\d+\$)?)?)((?:.(?:\d+|\*(?:\d+\$)?))?)([bcdeEfosuxX])/g;
...
DocumentSelection=new function(){
    ...
    var _=function(l,o){
        ...
        switch(o[0].tagName.toLowerCase()){
            case'input':
                if(["button","checkbox","hidden","image","radio","reset","submit"].indexOf((C.type||"").toLowerCase())>-1)return false;case'textarea':
                v="input";
                break;
            case'iframe':
                v="frame";
    ...
    var c=function(I,l,o){
        if(window.getSelection&&'iframe'!=I.tagName.toLowerCase()){
            ...
            else if(e+C.h>I.clientHeight)I.scrollTop=C.y-I.clientHeight/2;else I.scrollTop=l;
            if(o>C.x)I.scrollLeft=C.x;
            else if(o+I.clientWidth>C.x)I.scrollLeft=o;else I.scrollLeft=C.x-I.clientWidth/2
                }
            };
    
O.setRange=function(I,C,e,v){
    var V=I.scrollTop,x=I.scrollLeft;
    if(v){
        var X=O.getStart(I);
        e=X+e;
        C=X+C
...
O.insertAtCursor=function(i,I,C){
    var e=i.scrollTop,v=i.scrollLeft;
    if(!C){
        _('del',[i]);
    }
    var V=_('ins',[i,I]);
...
O.wrapSelection=function(I,l,o){
    var C=O.getCursorPosition(I),e=O.getEnd(I);
    if(C==e){
...
O.deleteAtCursor=function(I,l){
    if(!O.getSelection(I)){
        if(l)O.setRange(I,0,1,true);else O.setRange(I,-1,0,true);
    }
    return O.deleteSelection(I);
};

O.deleteSelection=function(i){
    var I=i.scrollLeft,C=i.scrollTop,e=_('del',[i]);
    c(i,C,I);
    return e
    };
...
DocumentSelection.module={
    'input':function(o){
        ...
        var Q=null;
        O.getContext=function(i){
            var l=O.getPos(i),_=i.value,c=_.match(new RegExp("(?:.|[\\r\\n]){0,"+(l[0]-1)+"}(?:^|\\s)","m"))||"",C=_.match(new RegExp("(?:.|[\\r\\n]){"+l[0]+"}","m"))[0],e=_.replace(C,""),v=e.substring(0,l[1]-l[0]),V=(e.replace(v,"")).match(/(?:\S|$)*/);
...
O.del=function(i){
    var l="",_=O.getPos(i),c=_[0],C=_[1];
    if(c!=C){
...
O.ins=function(i,l){
    var _="",c=O.getPos(i)[0],C=i.value.length;
    var e=document.selection&&!window.opera?i.value.replace(/\r/g,""):i.value;
...
'frame':function(){
    ...
    I.getContext=function(l){
        if('function'==typeof l.getSelection){
            var o=I.getPos(l),O=l.document.body.innerText||l.document.body.innerHTML.replace(/<\/?[a-z:]+[^>]*>/ig,"").replace("&nbsp;"," "),Q=O.match(new RegExp("(?:.|[\\r\\n]){0,"+(o[0]-1)+"}(?:^|\\s)","m"))||"",_=O.match(new RegExp("(?:.|[\\r\\n]){"+o[0]+"}","m"))||"",c=O.replace(_,""),C=c.substring(0,o[1]-o[0]),e=(c.replace(C,"")).match(/(?:\S|$)*/);
            return[_.toString().replace(Q,""),C,e]
            }else{
            var v=l.document.selection.createRange(),V=l.document.selection.createRange(),x=l.document.selection.createRange();
            v.moveStart("word",-1);
            x.moveEnd("word",1);
...
I.del=function(i){
    if('function'==typeof i.getSelection){
        var l=i.getSelection(),o=l.rangeCount;
...
I.ins=function(l,o){
    if('function'==typeof l.getSelection){
        ...
        var C=O.parentNode,c=O.nextSibling;
...
I.getSelectionOffset=function(i){
    ...
    if('function'==typeof i.getSelection){
        var o=i.getSelection().getRangeAt(0),O=i.document.createElement('span'),Q=o.cloneContents(),_=o.endOffset,c=O;
