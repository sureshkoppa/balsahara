<%-- 
    Document   : childList_Home_Report
    Created on : 2 Aug, 2011, 2:09:13 PM
    Author     : vinumol
--%>
     ...
     <s:if test="callforDPOChildList.size()!=0">
        ...
        <s:if test="childProfileIdList.size()!=0">
         <select name="childProfileId" id="childProfileId" onchange="javascript:show_details3(this);return false;">
                               ...
                               </select><%--s:select  name="childProfileId" list="childProfileIdList" headerValue="-- Please Select --" headerKey="1" ></s:select--%>
    </s:if>