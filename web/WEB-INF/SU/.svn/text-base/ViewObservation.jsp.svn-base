...
<html>
    ...
    <body>
        <s:form theme="css_xhtml" action="SU-observation-addObservation" name="AddObjForm" id="AddObjForm" onsubmit="javascript:check_obj(this);return false;">
         <center>
            <CAPTION><font size="3"><b><s:text name="heading.viewObserv"/></b></font></CAPTION><br/><br/>
            
            <s:if  test="%{addObjList.size()!=0}">
            <div> <font size="2"><s:text name="message.objOnDate"/>: </font><s:property value="selobjDate"/>
...
--%>       
         ...
         <table>
             <tr>
                 <td><s:submit value="Add Observation"/></td>
