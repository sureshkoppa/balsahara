 ...
 */
@Embeddable
public class CasehistoryPersonalPK implements Serializable {
    ...
    public CasehistoryPersonalPK() {
    }

    public CasehistoryPersonalPK(String childProfileId, Date lastModifiedDate) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof CasehistoryPersonalPK)) {
            return false;
        }
        CasehistoryPersonalPK other = (CasehistoryPersonalPK) object;
    ...
    public String toString() {
        return "com.cdac.usermanagement.ORM.CasehistoryPersonalPK[ childProfileId=" + childProfileId + ", lastModifiedDate=" + lastModifiedDate + " ]";
    }
