 ...
 */
@Embeddable
public class CasehistoryPrioradmEducationPK implements Serializable {
    ...
    public CasehistoryPrioradmEducationPK() {
    }

    public CasehistoryPrioradmEducationPK(String childProfileId, Date lastModifiedDate) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof CasehistoryPrioradmEducationPK)) {
            return false;
        }
        CasehistoryPrioradmEducationPK other = (CasehistoryPrioradmEducationPK) object;
    ...
    public String toString() {
        return "com.cdac.usermanagement.ORM.CasehistoryPrioradmEducationPK[ childProfileId=" + childProfileId + ", lastModifiedDate=" + lastModifiedDate + " ]";
    }
