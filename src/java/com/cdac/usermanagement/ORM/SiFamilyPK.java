 ...
 */
@Embeddable
public class SiFamilyPK implements Serializable {
    ...
    public SiFamilyPK(String childProfileId, Date lastModifiedDate) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof SiFamilyPK)) {
            return false;
        }
        SiFamilyPK other = (SiFamilyPK) object;
    ...
    public String toString() {
        return "com.cdac.usermanagement.ORM.SiFamilyPK[ childProfileId=" + childProfileId + ", lastModifiedDate=" + lastModifiedDate + " ]";
    }
