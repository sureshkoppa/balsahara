 ...
 */
@Embeddable
public class CasehistoryFamilyDetailsPK implements Serializable {
    ...
    public CasehistoryFamilyDetailsPK() {
    }

    public CasehistoryFamilyDetailsPK(String childProfileId, Date lastModifiedDate) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof CasehistoryFamilyDetailsPK)) {
            return false;
        }
        CasehistoryFamilyDetailsPK other = (CasehistoryFamilyDetailsPK) object;
    ...
    public String toString() {
        return "com.cdac.usermanagement.ORM.CasehistoryFamilyDetailsPK[ childProfileId=" + childProfileId + ", lastModifiedDate=" + lastModifiedDate + " ]";
    }
