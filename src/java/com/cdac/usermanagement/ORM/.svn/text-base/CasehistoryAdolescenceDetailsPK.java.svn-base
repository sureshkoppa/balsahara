 ...
 */
@Embeddable
public class CasehistoryAdolescenceDetailsPK implements Serializable {
    ...
    public CasehistoryAdolescenceDetailsPK() {
    }

    public CasehistoryAdolescenceDetailsPK(String childProfileId, Date lastModifiedDate) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof CasehistoryAdolescenceDetailsPK)) {
            return false;
        }
        CasehistoryAdolescenceDetailsPK other = (CasehistoryAdolescenceDetailsPK) object;
    ...
    public String toString() {
        return "com.cdac.usermanagement.ORM.CasehistoryAdolescenceDetailsPK[ childProfileId=" + childProfileId + ", lastModifiedDate=" + lastModifiedDate + " ]";
    }
