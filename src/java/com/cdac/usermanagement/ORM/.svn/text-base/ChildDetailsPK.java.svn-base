 ...
 */
@Embeddable
public class ChildDetailsPK implements Serializable {
    ...
    public ChildDetailsPK() {
    }

    public ChildDetailsPK(String childProfileId, Date lastModifiedDate) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ChildDetailsPK)) {
            return false;
        }
        ChildDetailsPK other = (ChildDetailsPK) object;
    ...
    public String toString() {
        return "com.cdac.usermanagement.ORM.ChildDetailsPK[ childProfileId=" + childProfileId + ", lastModifiedDate=" + lastModifiedDate + " ]";
    }
