 ...
 */
@Embeddable
public class SiChildDetailsPK implements Serializable {
    ...
    public SiChildDetailsPK() {
    }

    public SiChildDetailsPK(String childProfileId, Date lastModifiedDate) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof SiChildDetailsPK)) {
            return false;
        }
        SiChildDetailsPK other = (SiChildDetailsPK) object;
    ...
    public String toString() {
        return "com.cdac.usermanagement.ORM.SiChildDetailsPK[ childProfileId=" + childProfileId + ", lastModifiedDate=" + lastModifiedDate + " ]";
    }
