 ...
 */
@Embeddable
public class ResultOfEnqueryPK implements Serializable {
    ...
    public ResultOfEnqueryPK() {
    }

    public ResultOfEnqueryPK(String childProfileId, Date lastModifiedDate) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ResultOfEnqueryPK)) {
            return false;
        }
        ResultOfEnqueryPK other = (ResultOfEnqueryPK) object;
    ...
    public String toString() {
        return "com.cdac.usermanagement.ORM.ResultOfEnqueryPK[ childProfileId=" + childProfileId + ", lastModifiedDate=" + lastModifiedDate + " ]";
    }
