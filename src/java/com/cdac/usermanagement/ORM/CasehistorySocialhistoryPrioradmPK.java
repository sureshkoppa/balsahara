 ...
 */
@Embeddable
public class CasehistorySocialhistoryPrioradmPK implements Serializable {
    ...
    public CasehistorySocialhistoryPrioradmPK() {
    }

    public CasehistorySocialhistoryPrioradmPK(String childProfileId, Date lastModifiedDate) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof CasehistorySocialhistoryPrioradmPK)) {
            return false;
        }
        CasehistorySocialhistoryPrioradmPK other = (CasehistorySocialhistoryPrioradmPK) object;
    ...
    public String toString() {
        return "com.cdac.usermanagement.ORM.CasehistorySocialhistoryPrioradmPK[ childProfileId=" + childProfileId + ", lastModifiedDate=" + lastModifiedDate + " ]";
    }
