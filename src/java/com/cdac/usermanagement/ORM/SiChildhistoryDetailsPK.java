 ...
 */
@Embeddable
public class SiChildhistoryDetailsPK implements Serializable {
    ...
    public SiChildhistoryDetailsPK() {
    }

    public SiChildhistoryDetailsPK(String childProfileId, Date lastModifiedDate) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof SiChildhistoryDetailsPK)) {
            return false;
        }
        SiChildhistoryDetailsPK other = (SiChildhistoryDetailsPK) object;
    ...
    public String toString() {
        return "com.cdac.usermanagement.ORM.SiChildhistoryDetailsPK[ childProfileId=" + childProfileId + ", lastModifiedDate=" + lastModifiedDate + " ]";
    }
