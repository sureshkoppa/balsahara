...
<%@taglib  prefix="s" uri="/struts-tags" %>
   ...
   <s:if test="%{remove_item_detail!=null}">
                  ...
                  <s:if test="%{remove_item_detail.size()==0}">
                                <br/><br/>
                                <font style="font-size: medium"><s:text name="message.noItemsInCat"><s:param> <i><s:property value="removeitem_items_selectnames" escape="false"/></i>
                                             </s:param>
                                </s:text></font>
                  </s:if>  
                 <s:else>    
            <h1><s:text name="global.message.selItemDon"/>  <s:property value="removeitem_items_selectnames" escape="false"/>    </h1>
            ...
            <tr>  
                <td><s:checkbox name="donation_item_chk" fieldValue="%{itemNO}" value="false" theme="simple"/>
            ...
            <td><s:textfield  name="donation_item_quantity[%{itemNO}]" size="4" id="donation_item_qunatity" onfocus='VirtualKeyboard.attachInput(this);currentTB=this.id;' theme="simple"/></td>         
            <td><s:property value="UOM" escape="false"/></td>   
            <td><s:property value="unitPrice"/></td>
            <td><s:textarea name="donation_item_remarks[%{itemNO}]" rows="2" cols="10" id="donation_item_remarks" onfocus='VirtualKeyboard.attachInput(this);currentTB=this.id;' theme="simple"/></td>   
