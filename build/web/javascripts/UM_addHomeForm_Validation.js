...
$(function() {
        ...
        /*the folowing function is called when view Medical General register form is submitted*/
                $('form#addHomeFrom').submit(function(){
           //alert('hi'+$("#gender").val);
                    ...
                    /*****************REG EX*************************/
                     ...
                     if (undefined === $("input[name='genderId']:checked").val()) {
                                //alert('hi');
                                $dialog.html("Please select home is for boys or girls.");
                                ...
                                //alert('hi');
                                $dialog.html("Please enter homes address.");
                                $dialog.parent().addClass( "ui-state-error" );
                                $dialog.dialog('open');
                                return false;
                                }
